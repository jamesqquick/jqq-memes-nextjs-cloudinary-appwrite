...
export default function Footer() {
  return (
    <footer className="text-center w-full py-6 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 border-gray-500 bg-gray-900">
      <div className="text-gray-500 max-w-6xl mx-auto">
        <div className="flex flex-col mb-6 sm:mb-0 sm:flex-row gap-2">
          Powered by{': '}
          <span>
            <Link
              href="https://appwrite.io/"
              target="_blank"
              className="font-bold hover:underline transition hover:text-gray-200 underline-offset-2 text-gray-300"
            >
              Appwrite
            </Link>
          ...
          <span>
            <Link
              ...
              target="_blank"
              className="font-bold hover:underline hover:text-gray-200 transition underline-offset-2 text-gray-300"
            >
              Cloudinary
            </Link>
            <span className="hidden md:inline ">{' | '}</span>
      ...
      <div className="flex space-x-4 pb-4 sm:pb-0">
        <a
          className="group"
          aria-label="James Q Quick twitter"
        ...
        <a
          ...
          href="https://github.com/jamesqquick/jqq-memes-nextjs-cloudinary-appwrite"
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-gray-500 group-hover:fill-gray-300"
